  ...
  return (
    <div className="backBag">
      ...
      <div className="bagSect">
        <button className="btnBack" onClick={volver}>
          <svg
            width="24"
            height="24"
            viewBox="0 0 934 747"
          ...
          >
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M933.333 746.672C933.333 746.672 830.104 570.645 684.44 497.779C596.336 453.727 435.547 435.56 435.547 435.56V622.227L0 311.107L435.547 0V186.667C435.547 186.667 671 226.177 808.88 373.333C946.76 520.493 933.328 746.667 933.328 746.667L933.333 746.672Z"
              fill="black"
            />
          </svg>
        </button>
      ...
      {id.match.params.id === "sinMesa"|| 'undefined' ? (
        ...
        <div>
          ...
          <a
            ...
            target="_blank"
          >
            <button className="btnWssp">REALIZAR PEDIDO</button>
          </a>{" "}
        </div>
      )}
    </div>
